...
data gratr2-nt : Set where
  ...
  _start : gratr2-nt
  _posinfo : gratr2-nt
  _ows-star-27 : gratr2-nt
  _ows : gratr2-nt
  _comment-star-22 : gratr2-nt
  _comment : gratr2-nt
  _cmds : gratr2-nt
  _cmd : gratr2-nt
  _aws-bar-25 : gratr2-nt
  _aws-bar-24 : gratr2-nt
...
gratr2-nt-eq  _ws-plus-26 _ws-plus-26 = tt
...
gratr2-nt-eq  _ows-star-27 _ows-star-27 = tt
gratr2-nt-eq  _ows _ows = tt
gratr2-nt-eq  _comment-star-22 _comment-star-22 = tt
gratr2-nt-eq  _comment _comment = tt
gratr2-nt-eq  _cmds _cmds = tt
gratr2-nt-eq  _cmd _cmd = tt
gratr2-nt-eq  _aws-bar-25 _aws-bar-25 = tt
gratr2-nt-eq  _aws-bar-24 _aws-bar-24 = tt
...
stlc-start _ws-plus-26 = (just "P112" , nothing , just _ws-plus-26 , inj₁ _aws :: inj₁ _ws-plus-26 :: []) :: (just "P111" , nothing , just _ws-plus-26 , inj₁ _aws :: []) :: []
stlc-start _ws = (just "P113" , nothing , just _ws , inj₁ _ws-plus-26 :: []) :: []
...
stlc-start _type = (just "TpVar" , nothing , just _type , inj₁ _posinfo :: inj₁ _var :: inj₁ _posinfo :: []) :: (just "TpParens" , nothing , just _type , inj₂ '(' :: inj₁ _ows :: inj₁ _type :: inj₁ _ows :: inj₂ ')' :: []) :: []
stlc-start _term = (just "Var" , nothing , just _term , inj₁ _posinfo :: inj₁ _var :: inj₁ _posinfo :: []) :: (just "Parens" , nothing , just _term , inj₁ _posinfo :: inj₂ '(' :: inj₁ _ows :: inj₁ _term :: inj₁ _ows :: inj₂ ')' :: inj₁ _posinfo :: []) :: (just "Lam" , nothing , just _term , inj₁ _posinfo :: inj₂ 'λ' :: inj₁ _ows :: inj₁ _var :: inj₁ _ows :: inj₂ '.' :: inj₁ _ows :: inj₁ _term :: []) :: (just "Hole" , nothing , just _term , inj₁ _posinfo :: inj₂ '●' :: inj₁ _posinfo :: []) :: (just "Ascribe" , nothing , just _term , inj₁ _posinfo :: inj₂ '[' :: inj₁ _ows :: inj₁ _term :: inj₁ _ows :: inj₂ ':' :: inj₁ _ows :: inj₁ _type :: inj₁ _ows :: inj₂ ']' :: inj₁ _posinfo :: []) :: []
...
stlc-start _ows-star-27 = (just "P115" , nothing , just _ows-star-27 , inj₁ _aws :: inj₁ _ows-star-27 :: []) :: (just "P114" , nothing , just _ows-star-27 , []) :: []
stlc-start _ows = (just "P116" , nothing , just _ows , inj₁ _ows-star-27 :: []) :: []
stlc-start _comment-star-22 = (just "P102" , nothing , just _comment-star-22 , inj₁ _anychar :: inj₁ _comment-star-22 :: []) :: (just "P101" , nothing , just _comment-star-22 , []) :: []
stlc-start _comment = (just "P103" , nothing , just _comment , inj₂ '%' :: inj₁ _comment-star-22 :: inj₂ '\n' :: []) :: []
...
stlc-start _aws-bar-25 = (just "P109" , nothing , just _aws-bar-25 , inj₁ _aws-bar-24 :: []) :: (just "P108" , nothing , just _aws-bar-25 , inj₂ '\n' :: []) :: []
stlc-start _aws-bar-24 = (just "P107" , nothing , just _aws-bar-24 , inj₁ _aws-bar-23 :: []) :: (just "P106" , nothing , just _aws-bar-24 , inj₂ '\t' :: []) :: []
stlc-start _aws-bar-23 = (just "P105" , nothing , just _aws-bar-23 , inj₁ _comment :: []) :: (just "P104" , nothing , just _aws-bar-23 , inj₂ ' ' :: []) :: []
stlc-start _aws = (just "P110" , nothing , just _aws , inj₁ _aws-bar-25 :: []) :: []
stlc-start _anychar-bar-9 = (just "P75" , nothing , just _anychar-bar-9 , inj₂ '⇐' :: []) :: (just "P74" , nothing , just _anychar-bar-9 , inj₂ '=' :: []) :: []
stlc-start _anychar-bar-21 = (just "P99" , nothing , just _anychar-bar-21 , inj₁ _anychar-bar-20 :: []) :: (just "P98" , nothing , just _anychar-bar-21 , inj₁ _varone :: []) :: []
stlc-start _anychar-bar-20 = (just "P97" , nothing , just _anychar-bar-20 , inj₁ _anychar-bar-19 :: []) :: (just "P96" , nothing , just _anychar-bar-20 , inj₂ '\t' :: []) :: []
stlc-start _anychar-bar-19 = (just "P95" , nothing , just _anychar-bar-19 , inj₁ _anychar-bar-18 :: []) :: (just "P94" , nothing , just _anychar-bar-19 , inj₂ ' ' :: []) :: []
...
stlc-start _anychar-bar-16 = (just "P89" , nothing , just _anychar-bar-16 , inj₁ _anychar-bar-15 :: []) :: (just "P88" , nothing , just _anychar-bar-16 , inj₂ 'λ' :: []) :: []
...
stlc-start _anychar-bar-14 = (just "P85" , nothing , just _anychar-bar-14 , inj₁ _anychar-bar-13 :: []) :: (just "P84" , nothing , just _anychar-bar-14 , inj₂ ':' :: []) :: []
...
stlc-start _anychar = (just "P100" , nothing , just _anychar , inj₁ _anychar-bar-21 :: []) :: []
...
len-dec-rewrite {- Ascribe-} ((Id "Ascribe") :: (ParseTree (parsed-posinfo x0)) :: (InputChar '[') :: (ParseTree parsed-ows) :: (ParseTree (parsed-term x1)) :: (ParseTree parsed-ows) :: (InputChar ':') :: (ParseTree parsed-ows) :: (ParseTree (parsed-type x2)) :: (ParseTree parsed-ows) :: (InputChar ']') :: _::_(ParseTree (parsed-posinfo x3)) rest) = just (ParseTree (parsed-term (norm-term (Ascribe x0 x1 x2 x3))) ::' rest , 12)
...
len-dec-rewrite {- Hole-} ((Id "Hole") :: (ParseTree (parsed-posinfo x0)) :: (InputChar '●') :: _::_(ParseTree (parsed-posinfo x1)) rest) = just (ParseTree (parsed-term (norm-term (Hole x0 x1))) ::' rest , 4)
len-dec-rewrite {- Lam-} ((Id "Lam") :: (ParseTree (parsed-posinfo x0)) :: (InputChar 'λ') :: (ParseTree parsed-ows) :: (ParseTree (parsed-var x1)) :: (ParseTree parsed-ows) :: (InputChar '.') :: (ParseTree parsed-ows) :: _::_(ParseTree (parsed-term x2)) rest) = just (ParseTree (parsed-term (norm-term (Lam x0 x1 x2))) ::' rest , 9)
...
len-dec-rewrite {- P100-} ((Id "P100") :: _::_(ParseTree parsed-anychar-bar-21) rest) = just (ParseTree parsed-anychar ::' rest , 2)
len-dec-rewrite {- P102-} ((Id "P102") :: (ParseTree parsed-anychar) :: _::_(ParseTree parsed-comment-star-22) rest) = just (ParseTree parsed-comment-star-22 ::' rest , 3)
len-dec-rewrite {- P103-} ((Id "P103") :: (InputChar '%') :: (ParseTree parsed-comment-star-22) :: _::_(InputChar '\n') rest) = just (ParseTree parsed-comment ::' rest , 4)
len-dec-rewrite {- P104-} ((Id "P104") :: _::_(InputChar ' ') rest) = just (ParseTree parsed-aws-bar-23 ::' rest , 2)
len-dec-rewrite {- P105-} ((Id "P105") :: _::_(ParseTree parsed-comment) rest) = just (ParseTree parsed-aws-bar-23 ::' rest , 2)
len-dec-rewrite {- P106-} ((Id "P106") :: _::_(InputChar '\t') rest) = just (ParseTree parsed-aws-bar-24 ::' rest , 2)
len-dec-rewrite {- P107-} ((Id "P107") :: _::_(ParseTree parsed-aws-bar-23) rest) = just (ParseTree parsed-aws-bar-24 ::' rest , 2)
len-dec-rewrite {- P108-} ((Id "P108") :: _::_(InputChar '\n') rest) = just (ParseTree parsed-aws-bar-25 ::' rest , 2)
len-dec-rewrite {- P109-} ((Id "P109") :: _::_(ParseTree parsed-aws-bar-24) rest) = just (ParseTree parsed-aws-bar-25 ::' rest , 2)
...
len-dec-rewrite {- P110-} ((Id "P110") :: _::_(ParseTree parsed-aws-bar-25) rest) = just (ParseTree parsed-aws ::' rest , 2)
len-dec-rewrite {- P111-} ((Id "P111") :: _::_(ParseTree parsed-aws) rest) = just (ParseTree parsed-ws-plus-26 ::' rest , 2)
len-dec-rewrite {- P112-} ((Id "P112") :: (ParseTree parsed-aws) :: _::_(ParseTree parsed-ws-plus-26) rest) = just (ParseTree parsed-ws-plus-26 ::' rest , 3)
len-dec-rewrite {- P113-} ((Id "P113") :: _::_(ParseTree parsed-ws-plus-26) rest) = just (ParseTree parsed-ws ::' rest , 2)
len-dec-rewrite {- P115-} ((Id "P115") :: (ParseTree parsed-aws) :: _::_(ParseTree parsed-ows-star-27) rest) = just (ParseTree parsed-ows-star-27 ::' rest , 3)
len-dec-rewrite {- P116-} ((Id "P116") :: _::_(ParseTree parsed-ows-star-27) rest) = just (ParseTree parsed-ows ::' rest , 2)
...
len-dec-rewrite {- P84-} ((Id "P84") :: _::_(InputChar ':') rest) = just (ParseTree parsed-anychar-bar-14 ::' rest , 2)
...
len-dec-rewrite {- P88-} ((Id "P88") :: _::_(InputChar 'λ') rest) = just (ParseTree parsed-anychar-bar-16 ::' rest , 2)
...
len-dec-rewrite {- P94-} ((Id "P94") :: _::_(InputChar ' ') rest) = just (ParseTree parsed-anychar-bar-19 ::' rest , 2)
len-dec-rewrite {- P95-} ((Id "P95") :: _::_(ParseTree parsed-anychar-bar-18) rest) = just (ParseTree parsed-anychar-bar-19 ::' rest , 2)
len-dec-rewrite {- P96-} ((Id "P96") :: _::_(InputChar '\t') rest) = just (ParseTree parsed-anychar-bar-20 ::' rest , 2)
len-dec-rewrite {- P97-} ((Id "P97") :: _::_(ParseTree parsed-anychar-bar-19) rest) = just (ParseTree parsed-anychar-bar-20 ::' rest , 2)
len-dec-rewrite {- P98-} ((Id "P98") :: _::_(ParseTree (parsed-varone x0)) rest) = just (ParseTree parsed-anychar-bar-21 ::' rest , 2)
len-dec-rewrite {- P99-} ((Id "P99") :: _::_(ParseTree parsed-anychar-bar-20) rest) = just (ParseTree parsed-anychar-bar-21 ::' rest , 2)
len-dec-rewrite {- Parens-} ((Id "Parens") :: (ParseTree (parsed-posinfo x0)) :: (InputChar '(') :: (ParseTree parsed-ows) :: (ParseTree (parsed-term x1)) :: (ParseTree parsed-ows) :: (InputChar ')') :: _::_(ParseTree (parsed-posinfo x2)) rest) = just (ParseTree (parsed-term (norm-term (Parens x0 x1 x2))) ::' rest , 8)
...
len-dec-rewrite {- TpVar-} ((Id "TpVar") :: (ParseTree (parsed-posinfo x0)) :: (ParseTree (parsed-var x1)) :: _::_(ParseTree (parsed-posinfo x2)) rest) = just (ParseTree (parsed-type (norm-type (TpVar x0 x1 x2))) ::' rest , 4)
len-dec-rewrite {- Var-} ((Id "Var") :: (ParseTree (parsed-posinfo x0)) :: (ParseTree (parsed-var x1)) :: _::_(ParseTree (parsed-posinfo x2)) rest) = just (ParseTree (parsed-term (norm-term (Var x0 x1 x2))) ::' rest , 4)
len-dec-rewrite {- P101-} (_::_(Id "P101") rest) = just (ParseTree parsed-comment-star-22 ::' rest , 1)
len-dec-rewrite {- P114-} (_::_(Id "P114") rest) = just (ParseTree parsed-ows-star-27 ::' rest , 1)
