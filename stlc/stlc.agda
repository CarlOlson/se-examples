...
stlc-start _term = (just "Var" , nothing , just _term , inj₁ _var :: []) :: (just "Paren" , nothing , just _term , inj₂ '(' :: inj₁ _ows :: inj₁ _term :: inj₁ _ows :: inj₂ ')' :: []) :: (just "Lam" , nothing , just _term , inj₂ 'λ' :: inj₁ _ows :: inj₁ _var :: inj₁ _ows :: inj₂ '.' :: inj₁ _ows :: inj₁ _term :: []) :: (just "Hole" , nothing , just _term , inj₁ _posinfo :: inj₂ '●' :: inj₁ _posinfo :: []) :: (just "Ascribe" , nothing , just _term , inj₂ '[' :: inj₁ _ows :: inj₁ _term :: inj₁ _ows :: inj₂ ':' :: inj₁ _ows :: inj₁ _type :: inj₁ _ows :: inj₂ ']' :: []) :: []
